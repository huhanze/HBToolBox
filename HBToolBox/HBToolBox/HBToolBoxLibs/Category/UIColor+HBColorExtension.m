...
#import "UIColor+HBColorExtension.h"

@implementation UIColor (HBColorExtension)

/*
 通过16进制计算颜色
 */
+ (UIColor *)hb_colorFromHexRGB:(NSString *)colorString {
    return [UIColor hb_colorFromHexRGB:colorString andAlpha:1.0];
}
